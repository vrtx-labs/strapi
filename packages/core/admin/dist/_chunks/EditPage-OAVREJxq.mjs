...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-_P5nBW4-.mjs";
...
import { u as useWebhooks } from "./useWebhooks-Zc5L1oZz.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-kCrqFqIM.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-OAVREJxq.mjs.map
