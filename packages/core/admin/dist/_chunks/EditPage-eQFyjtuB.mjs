...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-9QEdq3sY.mjs";
...
import { u as useWebhooks } from "./useWebhooks-3EzQG9zW.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-48VzVHu7.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-eQFyjtuB.mjs.map
