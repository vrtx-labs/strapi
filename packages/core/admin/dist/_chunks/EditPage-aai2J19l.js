...
const useWebhooks = require("./useWebhooks-JrdwUeWw.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-FCca3AJm.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-aai2J19l.js.map
