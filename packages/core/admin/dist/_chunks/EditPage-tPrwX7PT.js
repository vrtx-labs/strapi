...
const useWebhooks = require("./useWebhooks-I3lXhROa.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-WlV6n5Ae.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-tPrwX7PT.js.map
