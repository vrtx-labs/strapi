...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-_nxMJvtQ.mjs";
...
import { u as useWebhooks } from "./useWebhooks-VH3lb7LA.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-YqWbbsIg.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-SQNJbkdD.mjs.map
