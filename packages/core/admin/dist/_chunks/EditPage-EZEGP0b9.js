...
const useWebhooks = require("./useWebhooks-S09bapyU.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-P9XgJcto.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-EZEGP0b9.js.map
