...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-9QEdq3sY.mjs";
      ...
      userLinksVisible && /* @__PURE__ */ jsx(
        LinkUserWrapper,
        {
          ...
          children: /* @__PURE__ */ jsx(FocusTrap, { onEscape: handleToggleUserLinks, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 0, children: [
            ...
            /* @__PURE__ */ jsxs(LinkUser, { tabIndex: 0, onClick: () => {
...
const CM = React.lazy(
  () => import("./index-9QEdq3sY.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-oDTIvJR8.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-otNllp17.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-UBPBfi09.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-9QEdq3sY.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-wIEUxTvu.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-JG7TQBoa.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-bRxZadcx.mjs.map
